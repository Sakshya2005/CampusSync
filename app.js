let totalSeconds = 600;
        ...
        function updateTimer() {
            ...
            if (totalSeconds > 0) {
                ...
                document.getElementById('timerRing').style.background = 
                    `conic-gradient(var(--primary-blue) ${degrees}deg, #e0e0e0 ${degrees}deg)`;
            } else {
        ...
        function toggleTimer() {
            ...
            document.getElementById('timerRing').style.opacity = timerRunning ? '1' : '0.6';
        }
        ...
        function validateForm() {
            const friendsSelected = document.querySelectorAll('#friendsGroup .option-item.selected').length > 0;
            const activitySelected = document.querySelectorAll('#activityGroup .option-item.selected').length > 0;
        ...
        const statuses = ["Cafe", "Library", "In Class", "Walking...", "Gym", "Dorm", "200m away", "5m away"];
